...
# # training the model
# model = Sequential()
# model.add(LSTM(lstm_params[0], input_shape=(look_back,22),return_sequences=True))
...
# model.save("my_h5_model_lstm.h5")


# joblib.dump(sc_y, "data_transformer.joblib")
reconstructed_model = tf.keras.models.load_model("my_h5_model_lstm.h5",compile=False)
...
for i in range(100):
  ...
  reconstructed_model.predict(X_train[0][np.newaxis,...])
...
converter_defaults = TFLiteConverter.from_keras_model(reconstructed_model)
TFLiteConverter.from_keras_mode

# converter_defaults = tf.lite.TFLiteConverter.from_saved_model("my_h5_model_lstm.h5")
...
tflite_models_dir = pathlib.Path("C:/Users/NGOCNEO/Desktop/Solar-Power-Generation-Forecasting-main/Solar-Power-Generation-Forecasting-main/LSTM")
